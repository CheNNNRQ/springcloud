...
public class PaymentService {
    ...
    public String paymentInfo_OK(Integer id) {
        return "线程池:  "+Thread.currentThread().getName()+"paymentInfo_OK    "+id+"\t"+"**********11";
    }
    ...
    public String paymentInfo_TimeoutHandler(Integer id) {
        return "线程池:  "+Thread.currentThread().getName()+"paymentInfo_TimeoutHandler    "+id+"\t"+"兜底的方法";
    }
